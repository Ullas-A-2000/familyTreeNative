...
(FamilyTree._defaultConfig = function (e) {
    ...
    if (y - 2 * this.config.padding >= n - l) T = (n + l) / 2 - y / 2;
      ...
      switch (
        ...
        case FamilyTree.orientation.right_top:
          (T = -(y / 2 - (l - n) / 2)) < this.config.padding - y &&
            (T = this.config.padding - y);
          break;
        ...
        case FamilyTree.orientation.left_top:
          (T = -(y / 2 - (n - l) / 2)) > -this.config.padding &&
            (T = -this.config.padding);
      }
    if (g - 2 * this.config.padding >= o - s) v = (o + s) / 2 - g / 2;
    else
      switch (
        ((v = -(g / 2 - (o - s) / 2)) > -this.config.padding &&
          (v = -this.config.padding),
        this.config.orientation)
      ) {
        case FamilyTree.orientation.bottom:
        case FamilyTree.orientation.bottom_left:
          (v = -(g / 2 - (s - o) / 2)) < this.config.padding - g &&
            (v = this.config.padding - g);
          break;
        case FamilyTree.orientation.left:
        case FamilyTree.orientation.right:
          v =
              ...
              case "transform":
                if (i[m][h]) {
                  ...
                  e[m].hasAttribute("transform")
                    ...
                    : (e[m].style.transform = "matrix(" + v.toString() + ")");
                }
                break;
              case "viewbox":
                if (i[m][h]) {
  ...
  (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
    ...
    FamilyTree.isNEU(g) && (g = ""),
      (T = FamilyTree.isNEU(T)
        ...
        : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${T}"></img>`);
    var w = !t,
      k = t ? "display:none;" : "",
      S = t || !s ? "display:none;" : "",
          ...
          if (Array.isArray(r)) {
            ...
            for (var a = 0; a < r.length; a++) {
              ...
              !FamilyTree.isNEU(s.id) &&
                ...
                (n = s.id),
                FamilyTree.isNEU(s.value) || I.push(`${o.label}: ${s.value}`),
                (e += s.html);
            }
            e += "</div>";
          } else {
            ...
            !FamilyTree.isNEU(s.id) &&
              ...
              FamilyTree.isNEU(s.value) &&
              (n = s.id),
              FamilyTree.isNEU(s.value) || I.push(`${r.label}: ${s.value}`),
              (e += s.html);
          }
        }
        return e;
  ...
  (FamilyTree.wrapText = function (e, t) {
    ...
    if (-1 != m.indexOf("multiline")) {
      ...
      for (var F = 1, x = !1, _ = 1; _ < g.length; _++) {
        ...
        if (
          ((v.firstChild.data += " " + g[_]), v.getComputedTextLength() > c)
        ) {
          if (
            ((v.firstChild.data = v.firstChild.data.slice(0, w)),
            F++,
            a && F > a)
          ) {
          ...
          (v = document.createElementNS(h, "tspan")).setAttributeNS(
            null,
            "x",
            l
          ),
      ...
      for (var c = 1; c < e.length; c++) {
        ...
        if (
          ...
          var f,
            ...
            T = o(p);
          i
            ? ((f = a(g, m.origPoint || y, t)), (u = a(g, p.origPoint || T, t)))
            : ((f = r(g, y, t)), (u = r(g, T, t))),
            n(h, f),
            (h.origPoint = g),
            l.push(h);
  ...
  (FamilyTree.prototype._pagesA100 = function (e, t, i, r) {
    ...
    if (!FamilyTree.EXPORT_PAGES_CUT_NODES && "fit" == e.scale) {
      ...
      for (
        var v = Object.keys(r.bordersByRootIdAndLevel),
          b = r.bordersByRootIdAndLevel[v[0]],
          F = Object.keys(b).length,
          x = 1;
        x < v.length;
        x++
      )
        F < Object.keys(r.bordersByRootIdAndLevel[v[x]]).length &&
          ((b = r.bordersByRootIdAndLevel[v[x]]), (F = Object.keys(b).length));
      for (var _ = 0, w = 0; ; ) {
        for (w = _; !(F <= _); ) {
      ...
      A = function (t) {
        if (C) {
          ...
          if (c.left || c.right || c.up || c.down) {
            ...
            for (var v = [], b = [], F = [], x = [], _ = 0; _ < h.length; _++)
              v.push(h[_][4]),
                b.push(h[_][5]),
                g[_]
            ...
            if (null != k) {
              ...
              for (
                var O = r.getNode(k), P = FamilyTree.getStParentNodes(O), B = 0;
                B < P.length;
                B++
              ) {
            ...
            for (_ = 0; _ < h.length; _++) {
              (h[_][4] = f[_].x + D),
                (h[_][5] = f[_].y + H),
                g[_] && ((g[_][4] = T[_].x + D), (g[_][5] = T[_].y + H)),
                (m[_].x = p[_].x + D),
                (m[_].y = p[_].y + H),
                (m[_].movex = D),
                (m[_].movey = H);
      ...
      L = function (t) {
        ...
        if (
          ...
          if (
            ...
            return I(k, S), void (r._gragStartedId = null);
        ...
        if (c) {
          ...
          if (g.left || g.right || g.up || g.down) {
            ...
            if (("draging" == o && ((o = null), (l = null)), null != o)) {
              ...
              for (
                var S = s.getNode(o), C = FamilyTree.getStParentNodes(S), N = 0;
                N < C.length;
                N++
              ) {
  ...
  (FamilyTree.manager._createNodes = function (e) {
        ...
        if (m) {
          ...
          if (!f) {
            if (!FamilyTree.isNEU(m.pid))
              (ue = (T = l[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
                T.childrenIds.splice(ue, 1);
            s.push(m);
          }
        }
      }
    ...
    for (c = 0; c < S.length; c++) {
      ...
      (g.partnerSeparation =
        Math.max(O.length, U.length) * t.partnerChildrenSplitSeparation +
      ...
      for (b = 0; b < g.subLevels; b++) {
        ...
        if ((FamilyTree.manager._initDinamicNode(z, g.lcn), (T = g.parent)))
          (ue = T.children.indexOf(g)) > -1 &&
            (T.children.splice(ue, 1), T.children.splice(ue, 0, z)),
            z.children.push(g),
            (z.parent = T),
            (g.parent = z),
            (l[z.id] = z);
    ...
    for (var $ in _) {
      ...
      if (j.length % 2) {
        ...
        FamilyTree.manager._initDinamicNode(Y, X.lcn, !0),
          (Y.isAssistant = !0),
          (Y.w = X.w),
          (Y.h = X.h),
          (l[Y.id] = Y),
          j.splice(j.length - 1, 0, Y.id);
      }
      var q = 1;
      for (b = j.length - 1; b >= 0; b--)
        if (b % 2 && b != j.length - 1) {
          var V = new FamilyTree.node(
            T.id + "_split_assitant_" + q,
            T.pid,
            [],
            "split"
          );
          ...
          for (var he = 0; he < te.layouts.length; he++) {
            ...
            if (pe.subLevels) {
              for (b = 0; b < pe.childrenIds.length; b++) {
                ...
                -1 != (ue = T.children.indexOf(D)) && T.children.splice(ue, 1),
                  (D.parent = fe),
                  fe.children.push(D);
              }
              T = fe;
            ...
            if (pe.layout == FamilyTree.layout.mixed) {
              ...
              FamilyTree.manager._initDinamicNode(z, T.lcn),
                (l[z.id] = z),
                (z.layout = pe.layout);
              var xe = [];
              for (c = pe.childrenIds.length - 1; c >= 0; c--) {
                for (
                  ...
                  T.children[b].id == D.id && T.children.splice(b, 1);
                if (
                  ((D.parent = null),
                  (D.layout = pe.layout),
              ...
              for (q = 1, b = xe.length - 1; b >= 0; b--)
                if (b % 2 && b != xe.length - 1) {
                  ...
                  FamilyTree.manager._initDinamicNode(V, T.lcn),
                    (V.layout = pe.layout),
                    (l[V.id] = V),
                    xe.splice(b, 0, V.id),
                    q++;
  ...
  (FamilyTree.manager._getResponse = function (
    ...
    for (var I = 0; I < d.length; I++)
      FamilyTree.manager._iterate2(d[I], h, r, s, c, m, y, p, i, T);
    return {
      animations: T,
      boundary: g,
      viewBox: s,
        ...
        if (
          ...
          for (var v = 0; v < i[g.id].length; v++) {
            ...
            b &&
              ...
              FamilyTree.manager._iterateFT(i[g.id][v], t, i, r, a, n, o, l, s);
          }
          ...
          (v = e.children[g]).parentPartner
            ? ((y.ppnodes[v.id] = v.parentPartner),
              ...
              1 == v.parentPartner.isPartner
                ? (-1 == y.rightIds.indexOf(v.parentPartner.id) &&
                    y.rightIds.push(v.parentPartner.id),
                  (y.indexes[v.id] = y.rightIds.indexOf(v.parentPartner.id)),
                  y.firstRight || (y.firstRight = v))
                : 2 == v.parentPartner.isPartner &&
                  (-1 == y.leftIds.indexOf(v.parentPartner.id) &&
                    y.leftIds.push(v.parentPartner.id),
                  (y.indexes[v.id] = y.leftIds.indexOf(v.parentPartner.id)),
                  (y.lastLeft = v)))
            : v.isPartner ||
              ((y.lastLeft = v), y.firstRight || (y.firstRight = v));
        }
      ...
      for (g = 0; g < e.children.length; g++) {
        ...
        if (v.isChildOfPartner)
          ...
          var w =
              v.isAssistant &&
              v.rightNeighbor &&
              v.rightNeighbor.isAssistant &&
              v.parent == v.rightNeighbor.parent,
            k =
              v.isAssistant &&
              v.leftNeighbor &&
              v.leftNeighbor.isAssistant &&
              v.parent == v.leftNeighbor.parent;
          if ((w || v.layout > 1) && v.rightNeighbor && v.rightNeighbor.isSplit)
            ...
            switch (s.orientation) {
              ...
              case FamilyTree.orientation.top_left:
                if (1 == v.isPartner)
                  F = FamilyTree.ui._linkLeftToRight(e, v, d, p);
                else if (2 == v.isPartner)
                  F = FamilyTree.ui._linkRightToLeft(e, v, d, p);
                else {
              ...
              case FamilyTree.orientation.right_top:
                if (1 == v.isPartner)
                  F = FamilyTree.ui._linkTopToBottom(e, v, d, p);
                else if (2 == v.isPartner)
                  F = FamilyTree.ui._linkBottomToTop(e, v, d, p);
                else {
                  _ = 1 == v.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
        ...
        FamilyTree.events.publish("render-link", [t, I]),
          c.push(I.html),
          o && m.push({ id: e.id, childId: v.id, html: I.html });
        var A = "";
        for (var L in t.config.linkBinding) {
          ...
          if (M) {
            ...
            (I.value = U),
              (I.element = d[L]),
              (I.name = E),
              !1 !== FamilyTree.events.publish("label", [t, I]) &&
                (FamilyTree.isNEU(I.value) ||
                  FamilyTree.isNEU(I.element) ||
                  (A += I.element.replace("{val}", I.value)));
          }
        }
        if ("" != A) {
          var O = F.x,
            P = F.y;
          null != v.movey && (P += v.movey),
            (A =
              FamilyTree.linkFieldsOpenTag
                .replace("{x}", O)
                .replace("{y}", P)
      ...
      if (t.sl == n.sl)
        ...
        for (; null == d; ) {
          ...
          if (
            (v.id == n.id
              ? (d = v)
              : FamilyTree._intersects(v, u, h) &&
                ((u = FamilyTree._addPoint(v, s, h, u, c)), (T = !0)),
            v.id != n.id)
          ) {
            for (; b; ) {
              if (b.id == n.id) {
              ...
              FamilyTree._intersects(b, u, h) &&
                ((u = FamilyTree._addPoint(b, s, h, u, c)), (T = !0)),
                (b = b.leftNeighbor);
            }
            for (; F; ) {
              if (F.id == n.id) {
              ...
              FamilyTree._intersects(F, u, h) &&
                ((u = FamilyTree._addPoint(F, s, h, u, c)), (T = !0)),
                (F = F.rightNeighbor);
            }
          }
          if (!T) {
            ...
            if (v.parent) {
              (f = h.levelSeparation),
                v.parent.layout && (f = h.mixedHierarchyNodesSeparation);
  ...
  (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
    ...
    for (p = n.length - 1; p >= 0; p--)
      v = (v = v.insert(n[p].start + n[p].length, "</mark>")).insert(
        n[p].start,
        "<mark>"
      );
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    if (T.length) {
      ...
      "male" == c.gender
        ? ((v.templateName = "wife"), (v._ft_partnerData.gender = "female"))
        : "female" == c.gender &&
          ((v.templateName = "husband"), (v._ft_partnerData.gender = "male")),
        c.pids.push(v.id),
        m.push(v);
    }
    ...
    for (var r = {}, a = {}, n = {}, o = 0; o < e.length; o++) {
      if ((h = e[o]).stContainerNodes)
        for (var l = h.stContainerNodes.length - 1; l >= 0; l--) {
          ...
          if (
            ((s.w = d.maxX - d.minX + s.padding[3] + s.padding[1]),
            (s.h = d.maxY - d.minY + s.padding[0] + s.padding[2]),
            s.stChildren.length &&
              0 == s.padding[0] &&
              0 == s.padding[1] &&
              0 == s.padding[2] &&
            ...
            ((c.orientation == FamilyTree.orientation.bottom &&
              m.orientation == FamilyTree.orientation.top) ||
              (c.orientation == FamilyTree.orientation.top &&
                m.orientation == FamilyTree.orientation.bottom)) &&
              FamilyTree.local._centerGroupIfBidirectionalChart(
                h,
                s,
                a,
                d,
              ...
              ((c.orientation == FamilyTree.orientation.left &&
                m.orientation == FamilyTree.orientation.right) ||
                (c.orientation == FamilyTree.orientation.right &&
                  m.orientation == FamilyTree.orientation.left)) &&
                FamilyTree.local._centerGroupIfBidirectionalChart(
                  h,
                  s,
                  n,
  ...
  (FamilyTree.local._walk = function (e, t) {
    for (
      var i = { minX: null, minY: null, maxX: null, maxY: null },
        r = [],
        a = [],
        n = [],
        o = 0;
      ...
      if (
        ...
        if (
          (s.isAssistant &&
            d.isAssistant &&
            e.children.length > 1 &&
            e.children[1].isSplit &&
            (c =
              e.children[1]._prelim + FamilyTree.local._mid(e.children[1], a)),
          ((s.layout &&
            d.layout &&
            !s.isMirror &&
            !d.isMirror &&
    ...
    if (t <= FamilyTree.MAX_DEPTH && !e.isPartner) {
      ...
      if (((c = a[t]), (l = FamilyTree.local._getNodeHeight(e, o)), e.layout)) {
        ...
        e.leftNeighbor &&
          ...
          e.leftNeighbor.leftNeighbor &&
            e.leftNeighbor.leftNeighbor.layout &&
            e.leftNeighbor.leftNeighbor.pid == e.pid &&
            (p = FamilyTree.local._getNodeHeight(
              e.leftNeighbor.leftNeighbor,
              o
            ))),
          e.rightNeighbor &&
            ...
            e.rightNeighbor.rightNeighbor &&
              e.rightNeighbor.rightNeighbor.layout &&
              e.rightNeighbor.rightNeighbor.pid == e.pid &&
              (f = FamilyTree.local._getNodeHeight(
                e.rightNeighbor.rightNeighbor,
                o
              ))),
      ...
      switch (
        ...
        (e.isSplit || e.isAssistant || e.layout > 1) &&
          (e.y = d + c / 2 - l / 2),
        o.orientation)
      ) {
        case FamilyTree.orientation.right:
      ...
      if ((FamilyTree._setMinMaxXY(e, n), 0 != e.children)) {
        ...
        if (
          ...
          e.children[g].isPartner)
        ) {
          for (; e.children.length - 1 > g && e.children[g].isPartner; )
            FamilyTree._setMinMaxXY(e.children[g], n), g++;
          FamilyTree._setMinMaxXY(e.children[g], n),
            FamilyTree.local._secondWalk(
              e.children[g],
              t + 1,
              i + e._modifier,
    ...
    if (!e.isPartner)
      for (
        ...
        e.layout > 1 && (p = r.mixedHierarchyNodesSeparation),
          ((e.leftNeighbor &&
            e.parent == e.leftNeighbor.parent &&
            "string" == typeof e.leftNeighbor.id &&
            -1 != e.leftNeighbor.id.indexOf("_sublevel_layout_")) ||
            1 == e.leftNeighbor.layout) &&
            (p = r.subtreeSeparation);
        var f =
          n._prelim +
          d +
        ...
        if (f > 0) {
          for (
            var u = e, y = 0;
            null != u && u != m;
            u = FamilyTree.local._getLeftSibling(u)
          )
            y++;
          if (null != u) {
            var g = e,
            ...
            for (
              "string" == typeof g.id &&
              -1 != g.id.indexOf("_grid_pseudo_node_") &&
              (T = 0);
              g != m;
...
(FamilyTree.local._nodeWithPartnersSize = function (e, t) {
            ...
            ? ((o = e.parent.x + e.parent.w + e.parent.partnerSeparation),
              h
                ? ((l =
                  ...
                  (m = u.h),
                  (h = !1))
                : ((l += m + t.partnerNodeSeparation), (m = u.h)),
              (u.x = o),
              (u.y = l))
            : 2 == u.isPartner &&
              ...
              p
                ? ((d =
                  ...
                  (c = u.h),
                  (p = !1))
                : ((d += c + t.partnerNodeSeparation), (c = u.h)),
              (u.x = s),
              (u.y = d));
        }
        break;
              ...
              ? ((l = e.parent.y + e.parent.h + e.parent.partnerSeparation),
                h
                  ? ((o =
                    ...
                    (m = u.w),
                    (h = !1))
                  : ((o += m + t.partnerNodeSeparation), (m = u.w)),
                (u.x = o),
                (u.y = l))
              : 2 == u.isPartner &&
                ...
                p
                  ? ((s =
                    ...
                    (c = u.w),
                    (p = !1))
                  : ((s += c + t.partnerNodeSeparation), (c = u.w)),
                (u.x = s),
                (u.y = d)));
        }
    }
  ...
  (FamilyTree.local._centerGroupIfBidirectionalChart = function (
    e,
    t,
    i,
    r,
    ...
    for (
      var n = a.toUpperCase(),
        ...
        d = null,
        c = 0;
      c < t.stChildren.length;
      c++
    )
      (null === s || t.stChildren[c][a] > s + t.stChildren[c][l]) &&
        (s = t.stChildren[c][a] + t.stChildren[c][l]),
        (null === d || d < t.stChildren[c][a]) && (d = t.stChildren[c][a]);
    i[e.id] || (i[e.id] = {});
    var m = (s - d) / 2 + d,
      h = r[o] - s + (s - d) / 2;
    h > m
      ? ((i[e.id][t.id] = h - m), (t[l] = 2 * h))
      : ((i[e.id][t.id] = 0), (t[l] = 2 * m));
  });
